...
parser.add_argument('--progress', type=bool, default=True, help='Show progress bar?')
parser.add_argument('--cachedir', type=str, default='.tick-data', help='Download cache directory')
parser.add_argument('--header', type=bool, default=True, help='Output column headers?')
